...
import {  crisper_epigenome_data as data } from '@/utils/datas/static-data';
import { target_genome,epigenome_PAM_Types as PAM_Types } from '../../utils/datas/options';
import {epigenome_form_origin as origin} from '../../utils/datas/form-origin';


// Cas9组件
function CrisperEpigenome() {
    // 介绍
    ...
    const handleConfirm = () => {
        ...
        // 4，跳转到结果页面
        navigate('/crispr/result/ep_submit', {
            state: {
                token: designToken,
    ...
    const handleStartDesign = async () => {
        ...
        try {
           ...
           localStorage.setItem('ep_design_params', JSON.stringify(tempFormData));
           localStorage.setItem('ep_design_token', token);
                ...
                <div className="introduction_text">
                    <div className="introduction_text_top">
                        ...
                        <p className="introduction_content">
                            ...
                            <a href="https://www.nature.com/articles/s41556-020-00620-7" target="_blank" rel="noopener noreferrer">
                                <InfoCircleOutlined />
                            </a>
                        </p>
                    </div>
                    <div className="introduction_text_bottom">
                        <h3>Available modifications include:</h3>
...
// 导出Cas9组件
export default CrisperEpigenome;