    ...
    return (
        <>
                    ...
                    label={
                        <span>
                            ...
                            <span
                                ...
                                style={{ textDecoration: 'underline', color: '#1B2AE6', marginLeft: '10px' }}
                            >
            ...
            <div className="email" style={{ color: '#758a70', display: 'flex', justifyContent: 'start' }}>
                <p><MailOutlined /> Note: For a Customized PAM select Customized PAM: 5&apos;-XXX-3&apos; in PAM Type and then set sgRNA module and Spacer length .</p>
            </div>

            <Row gutter={24}>
                <Col span={8}>
                    {/* 输入框 */}
                    <Form.Item label="Customized PAM (Need to select Customized PAM in PAM Type )" name={'customized_pam'} style={{ marginRight: '30px' }}>
                        <Input
                ...
                <Col span={8}>
                    <Form.Item label='sgRNA module of Customized PAM' name={'sgRNA_module'} style={{ flex: 1, marginRight: '30px' }}>
                        <Select
                            placeholder="Select"
                            value={sgRNAmodule}
