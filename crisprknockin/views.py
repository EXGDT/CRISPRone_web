...
def crisprknockin_submit(request):
    if request.method == "POST":
        ...
        return render(request, 'crisprknockin/crisprknockin_result.html', form_inputs)
    else:
        return render(request, 'crisprknockin/crisprknockin_submit.html')
